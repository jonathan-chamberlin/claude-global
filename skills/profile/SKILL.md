...
python scripts/profiler.py --target "python main.py --episodes 50"

# Memory profile
python scripts/memory_profiler.py --target "python main.py --episodes 20"

# Profile specific module
python scripts/profiler.py --target "python -c 'from training.trainer import Trainer; ...'"
```
